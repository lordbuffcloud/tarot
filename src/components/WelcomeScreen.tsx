  ...
  return (
    ...
    >
      <header className="mb-10 text-center max-w-3xl">
        <h1 className="text-4xl sm:text-5xl font-bold text-astral-amethyst filter drop-shadow-[0_0_5px_rgba(106,13,173,0.8)] mb-6">
          Welcome, Seeker of Truth
        </h1>
        <p className="text-lg text-mystic-text/90 mb-4 leading-relaxed">
        ...
        <p className="text-md text-ethereal-blue mb-6 leading-relaxed">
      ...
      <main className="w-full max-w-2xl bg-astral-bg shadow-2xl shadow-esoteric-purple/30 rounded-lg p-6 sm:p-8 ring-1 ring-esoteric-purple/50">
        <section className="mb-8 prose-tarot prose-sm max-w-none">
          ...
          <ol className="list-decimal pl-5 space-y-3 text-mystic-text/80 leading-relaxed">
            <li>
        ...
        <section className="mb-8 prose-tarot prose-sm max-w-none">
          ...
          <p className="text-mystic-text/80 leading-relaxed">
        ...
        <div className="text-center">
          <button
            onClick={onNext}
            className="bg-astral-amethyst hover:bg-starlight-gold hover:text-mystic-dark text-white font-semibold py-3 px-8 rounded-md shadow-lg hover:shadow-starlight-gold/50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-mystic-dark focus:ring-starlight-gold transition-all duration-300 ease-in-out transform hover:scale-105 text-lg"
          >
